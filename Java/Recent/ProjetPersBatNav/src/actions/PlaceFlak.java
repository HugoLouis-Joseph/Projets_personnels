 ...
 */
public class PlaceFlak extends Action {

    /**
     * Creates a new PlaceShip action
     * @param board board
     */
    public PlaceFlak(Board board) {
        super("PlaceFlak",board);
    }
    ...
    public void act() {
        ...
        FlakShip flak = new FlakShip(2, dir , cpl);
        this.board.addFlak(flak);
        this.board.placeShip(cpl , flak , true);
        System.out.println("");
